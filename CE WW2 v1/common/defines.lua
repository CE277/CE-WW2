...
country = {
	...
	GOLD_TO_CASH_RATE = 1.2, -- Amount of money generated per gold unit
	...
	UNCIV_TECH_SPREAD_MIN = 0.30, --Minimum techs an unciv will get on westernizing
...
military = {
	...
	SIEGE_BRIGADES_BONUS = 2.8, -- the bonus to siege speed from each brigade
	RECON_SIEGE_EFFECT = 0, -- multiplier to effect of recon on speeding up sieges
...
diplomacy = {
	...
	PUPPET_BONUS_INFLUENCE_PERCENT = 300.0, -- bonus if they are our puppet
...
pops = {
	...
	MIL_TO_JOIN_REBEL = 4, -- Rebels over this will join a faction
	...
	LUXURY_CON_CHANGE = 0.01, -- con boost from over-buying luxury goods
...
ai =
{
	...
	INDUSTRYWORKER_WEIGHT = 8.0, -- ai weight for new industry workers
